...
static void PrintActiveBehaviorOverrides() {
    const std::vector<std::pair<const char*, const char*>> overrides = {
        ...
        {"LITE3_TRAINING_DECIMATION", "training decimation override for timing parity assert"},
        {"LITE3_TRAINING_SIM_DT", "training sim dt override for timing parity assert"},
        {"LITE3_TIMING_ASSERT_TOL", "timing parity assert tolerance override"},
